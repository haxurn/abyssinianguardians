      ...
      >
        <Card className="bg-white/10 border-white/20 backdrop-blur-md">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-300">Join CyberGuard and secure your digital future</CardDescription>
          </CardHeader>
          <CardContent>
